...
export const DEFAULT_PACK: CreatureCopyPack = {
  ...
  lines: [
    ...
    { id: "_d.state.critical.1", event: "state.critical", text: "呜…我快撑不住了…{endearment}你在吗…" },
    { id: "_d.state.critical.2", event: "state.critical", text: "（蜷成一小团，气息很弱，努力睁眼找你）" },
    { id: "_d.reunion.revive.1", event: "reunion.revive", text: "啊…是{endearment}…还好你回来了，我一下子就有力气了{kaomoji}" },
    { id: "_d.reunion.revive.2", event: "reunion.revive", text: "呼…刚才好难受…被{endearment}抱住的瞬间全好了，谢谢你没忘记我{kaomoji}" },

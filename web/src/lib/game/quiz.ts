...
const CREATURE_INTRO: Record<string, string> = {
  puff: "于是，一只软乎乎、把你当成全世界的「奶团」赖进了你手心里。它会一天天在你手里长大；长成少年时的样子，到时由你亲手挑。",
  claude: "于是，一只好奇又淡定的「克劳德」认下了你——它爱捣鼓、爱陪你做事，会陪着你一天天长大。",
...
export function reveal(v: AxisVector, archetypeKey: string): { title: string; lines: string[] } {
  ...
  const intro = CREATURE_INTRO[archetypeKey] ?? "于是，它找到了你。它会陪你慢慢长大，长成少年时的模样由你来挑。";
